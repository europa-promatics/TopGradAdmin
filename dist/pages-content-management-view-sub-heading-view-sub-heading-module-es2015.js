...
let ViewSubHeadingComponent = class ViewSubHeadingComponent {
    constructor(route, Service, _formBuilder, _snackBar, location) {
        this.route = route;
