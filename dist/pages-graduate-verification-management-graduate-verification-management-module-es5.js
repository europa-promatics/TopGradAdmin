(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-graduate-verification-management-graduate-verification-management-module"], {
    /***/
    "+6z5": function z5(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "GraduateVerificationManagementRoutingModule", function () {
        return GraduateVerificationManagementRoutingModule;
      });
      /* harmony import */
      ...
      var _graduate_verification_management_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./graduate-verification-management.component */
      "oq2z");
      ...
      var GraduateVerificationManagementRoutingModule = function GraduateVerificationManagementRoutingModule() {
        _classCallCheck(this, GraduateVerificationManagementRoutingModule);
      };

      GraduateVerificationManagementRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    "dWwi": function dWwi(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    "jfmz": function jfmz(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    "oq2z": function oq2z(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "GraduateVerificationManagementComponent", function () {
        return GraduateVerificationManagementComponent;
      });
      /* harmony import */
      ...
      var _raw_loader_graduate_verification_management_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./graduate-verification-management.component.html */
      "jfmz");
      /* harmony import */


      var _graduate_verification_management_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./graduate-verification-management.component.scss */
      "dWwi");
      /* harmony import */
      ...
      var GraduateVerificationManagementComponent = /*#__PURE__*/function () {
        function GraduateVerificationManagementComponent(Service, _snackBar, router, fb) {
          _classCallCheck(this, GraduateVerificationManagementComponent);
        ...
        _createClass(GraduateVerificationManagementComponent, [{
          key: "ngOnInit",
          ...
          value: function getcontent() {
            ...
            this.Service.graduateVerificationcontent().subscribe(function (data) {
              ...
              _this.WhyVerifiedSection.patchValue({
                is_visible: data.data.section_2.is_visible
              });

              data.data.section_2.data.forEach(function (element) {
                _this.verificatonArray.push(_this.fb.group({
              ...
              _this.verificationSection.patchValue({
              ...
              _this.FAQSection.patchValue({
                is_visible: data.data.section_6.is_visible
              });

              data.data.section_6.question_answers.forEach(function (element) {
                _this.FaqArray.push(_this.fb.group({
          ...
          key: "onVerificationChangeImage",
          value: function onVerificationChangeImage(e, index) {
            var _this2 = this;
            ...
            if (fileType == "image") {
              ...
              this.Service.uploadbenefitmedia(formData).subscribe(function (resp) {
                ...
                _this2.verificatonArray.at(index).patchValue({
                  image: resp
                });

                console.log("full form", _this2.WhyVerifiedSection);
              });
          ...
          key: "onStepsChangeImage",
          value: function onStepsChangeImage(e, index) {
            var _this3 = this;
            ...
            if (fileType == "image") {
              ...
              this.Service.uploadbenefitmedia(formData).subscribe(function (resp) {
                ...
                _this3.stepsArray.at(index).patchValue({
                  image: resp
                });

                console.log("full form", _this3.stepSection);
              });
          ...
          value: function setHeadingImage(event) {
            ...
            if (fileType == "image") {
              ...
              reader.onload = function (event) {
                _this4.HeadingImage1 = event.target.result;
              };
          ...
          value: function setHeadingImage1(event) {
            ...
            if (fileType == "image") {
              ...
              reader.onload = function (event) {
                _this5.HeadingImage2 = event.target.result;
              };
          ...
          key: "postcontent",
          value: function postcontent(type, id) {
            var _this6 = this;
            ...
            if (type == 'howVerified') {
              if (this.getverifiedSection.valid) {
                ...
                _formdata.append("section_3", JSON.stringify(section_3));
            ...
            if (type == 'getverified') {
              if (this.verificationSection.valid) {
                ...
                if (this.headingImageObj) {
                  ...
                  _formdata2.append("section_5", JSON.stringify(_section_2));

                  _formdata2.append("image", this.HeadingImage2);
                }
            ...
            if (type == 'icons') {
              if (this.WhyVerifiedSection.valid) {
                if (this.verificatonArray.valid) {
                  ...
                  var section_2 = {
                    data: this.WhyVerifiedSection.get('verificatonArray').value,
                    is_visible: this.WhyVerifiedSection.controls['is_visible'].value
                  };

                  _formdata3.append("section_2", JSON.stringify(section_2));
            ...
            if (type == 'faq') {
              if (this.FAQSection.valid) {
                if (this.FaqArray.valid) {
                  ...
                  var section_6 = {
                    question_answers: this.FAQSection.get('FaqArray').value,
            ...
            this.Service.postGraduateVerificationContent(obj).subscribe(function (resp) {
          ...
          key: "poststepsArray",
          value: function poststepsArray(id) {
            var _this7 = this;
            ...
            if (this.stepSection.valid) {
              if (this.stepsArray.valid) {
                ...
                var formdata = new FormData();
                var ind = this.stepsArray.value.findIndex(function (val) {
                  return val.endoresement_primary_id == id;
            ...
            this.Service.poststepsArrayContent(obj).subscribe(function (resp) {
              _this7.Service.showMessage({
                message: "Submitted Successfully"
              });
            });
          }
      ...
      GraduateVerificationManagementComponent.ctorParameters = function () {
        return [{
      ...
      GraduateVerificationManagementComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    "qA8f": function qA8f(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "GraduateVerificationManagementModule", function () {
        return GraduateVerificationManagementModule;
      });
      /* harmony import */
      ...
      var _graduate_verification_management_routing_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./graduate-verification-management-routing.module */
      "+6z5");
      /* harmony import */


      var _graduate_verification_management_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./graduate-verification-management.component */
      "oq2z");

      var GraduateVerificationManagementModule = function GraduateVerificationManagementModule() {
        _classCallCheck(this, GraduateVerificationManagementModule);
      };

      GraduateVerificationManagementModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [_graduate_verification_management_component__WEBPACK_IMPORTED_MODULE_7__["GraduateVerificationManagementComponent"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _tinymce_tinymce_angular__WEBPACK_IMPORTED_MODULE_3__["EditorModule"], _angular_material_slide_toggle__WEBPACK_IMPORTED_MODULE_4__["MatSlideToggleModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"], _graduate_verification_management_routing_module__WEBPACK_IMPORTED_MODULE_6__["GraduateVerificationManagementRoutingModule"]]
      })], GraduateVerificationManagementModule);
      /***/
    }
  }]);
})();
//# sourceMappingURL=pages-graduate-verification-management-graduate-verification-management-module-es5.js.map