...
export class DashboardComponent implements OnInit {
  ...
  public barChartLabels1: string[] = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul'];
  public barChartData1: any[] = [
    {data: [65, 59, 80, 81, 56, 55, 48], label: 'No. of Graduates'}
  ];

    public barChartLabelsqg: string[] = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul'];
  public barChartDataqg: any[] = [
    {data: [65, 59, 80, 81, 56, 55, 48], label: 'No. of Graduates'}
  ];


   public barChartLabelsint: string[] = ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'];
  public barChartDataint: any[] = [
   ...
   public barChartLabelsji: string[] = ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'];
  ...
  // Pie
  public pieChartLabels: string[] = ['IT', 'Health', 'Agriculture', 'Accounting', 'Engineering', 'Government'];
  public pieChartData: number[] = [300, 200, 400, 500, 100, 450];
  public pieChartType = 'pie';


  // Pie2
  public pieChartLabels2: string[] = ['Employers Posting Jobs', 'Employers Not Posting Jobs'];
  public pieChartData2: number[] = [700, 500];
